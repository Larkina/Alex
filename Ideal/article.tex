...
\end{equation}
Уравнение (\ref{e4}) может быть решено разделением переменных
...
\end{equation}
Уравнение (\ref{e5}) есть диффиренциальное уравнение Бесселя порядка $l$, а общее решение ур. (\ref{e6}) имеет вид
...
\begin{figure}[t]
  ...
  ур. (\ref{e2}) и внешняя граница зафиксирована в $r=b$. Однако реальная внутренняя граница расположена в 
...
\mu_r \to 0$ и $\mu_\theta \to \infty$, когда $r \to a$, и функции Бесселя второго рода в ур. (\ref{e7}) имеют 
...
вычисляются согласно формуле (\ref{e2}), как будто внутренняя граница не поменялась. Внешняя граница остается
